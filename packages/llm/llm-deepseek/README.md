...
Route model requests and file uploads through a dedicated HTTP/HTTPS proxy without affecting web search or other tool traffic. Omit both fields to keep process-wide proxy rules (for example, `~/.dsh/.env`).
